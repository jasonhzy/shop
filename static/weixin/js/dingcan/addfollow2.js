...
$(function(){
	...
	check_tuwen(1);
	var url = APP+"?g=admin&m=keyword&a=showfollow";
...
function zsc_addimg(num){
	if($('.simgcon').length<9){
		...
		var zsc_html = "<a href=\"javascript:;\" class=\"simgcon\" id=\"zsc_imgs"+num+"\">"+
					   ...
					   "<img src=\""+URL+"/static/weixin/images/dingcan/op-del.png\" onclick=\"zsc_delimg("+num+")\" /></b>"+
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		var url = APP+"?g=admin&m=keyword&a=addfollow&op=add";
