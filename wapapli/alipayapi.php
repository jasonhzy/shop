...
$url=substr($url,0,strpos($url,"/wapapli/"));
...
//服务器异步通知页面路径
$notify_url = $url."/wapapli/notify_url.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//页面跳转同步通知页面路径
      //$call_back_url = "http://127.0.0.1:8800/wapapli/call_back_url.php";
$call_back_url = $url."/wapapli/call_back_url.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数
...
//建立请求
$alipaySubmit = new AlipaySubmit($alipay_config);
$html_text = $alipaySubmit->buildRequestForm($parameter, 'get', '正在为您跳转到支付宝支付界面!');
echo $html_text;
?>
</body>
</html>